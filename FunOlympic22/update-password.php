...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a class="navbar-brand" href="#">Have some patience please.</a>
      ...
      <div class="col-md-10">
        ...
        <form action="" method="get">
          <div class="form-group">
            ...
            <input type="text" name="username" id="username" class="form-control" placeholder="Old username"
          ...
          <div class="form-group">
            ...
            <input type="text" name="cpassword" id="password" class="form-control" placeholder="Confirm Password"
              aria-describedby="helpId" required autofocus>
          </div>
          ...
          <a href="signup.php" class="btn btn-primary btn-block" style="margin:10px 0px">Create New Account</a>
