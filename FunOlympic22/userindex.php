    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid text-center mb-0 ">
            <div class="container" data-aos="fade-up">
                ...
                <p class="lead">
                    <a class="btn" id="greenbtn" style="background-color: #0c5460; color:white;" href="about-us.php" role="button">Read more</a>
                </p>
                        ...
                        ?>
                            <div class="col-md-9">
                                ...
                                <p>
                                    <?php echo $c; ?>
                                <p>
                                    <a href="post.php ?id=<?php echo $a; ?>" id="greenbtn" class="btn greenbtn"  style="background-color: #0c5460; color:white;">Read more</a>
                                </p>
                            </div>
                            <div class="col-md-3">
