    ...
    <body>
        ...
        <div class="container-fluid mt-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1 class="text-info">Users Information </h1>
                    <table class="table table-border table-info table-hover table-striped">
                        <thead>
                            <th>UserID</th>
                            <th>First Name</th>
                            <th>Last Name</th>
                        ...
                        while ($row = mysqli_fetch_array($run)) {
                            ...
                            <tbody class="table-striped ">
                                ...
                                <td>
                                    <a href="edit.php?id=<?php echo $a; ?> &fname=<?php echo $b;?> &lname=<?php echo $c ?> &username=<?php echo $d ?> &password=<?php echo $e ?>" class="btn btn-success">Edit</a>
                                </td>
                                <td>
